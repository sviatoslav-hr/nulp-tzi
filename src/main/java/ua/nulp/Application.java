...
import ua.nulp.service.implementation.AlphabetPropertiesService;
...
public class Application {
    ...
    public static void main(String[] args) {
        new MainController(new MainFrame(), new TextAnalysingServiceImpl(), new AlphabetPropertiesService());
    }
}
